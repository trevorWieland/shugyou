...
⚠ ORCHESTRATOR-OWNED ARTIFACT — DO NOT EDIT: plan.md and progress.json are generated from the typed task store. phase-events.jsonl is append-only via typed tools. Postflight reverts unauthorized edits and emits an UnauthorizedArtifactEdit event.
